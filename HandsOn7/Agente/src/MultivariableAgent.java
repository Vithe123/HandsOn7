...
public class MultivariableAgent extends Agent
{
    ...
    */
    ...
    static float FuncionDeterminarFitness(int contador)
    {
        float resultado;
    ...
    static double DeterminarFitness(boolean mayor, float x)
    {
        if(mayor == false)
        {
            return x/30;
    ...
    public static void DeterminarPuntajes(){
        ...
        for (int i = 0; i < CantidadInd; i++)
        {
            float resFuncion = FuncionDeterminarFitness(i);
            mayor = true;
            if(resFuncion < 30)
                mayor = false;

            Individuo ind = poblacionA.get(i);
            ind.Puntaje = (float) (DeterminarFitness(mayor, resFuncion));
    ...
    static void Combinacion()
    {
        ...
        int mutacion = ObtenerRandomEntero(0,A_Padre1.length());
        ...
        mutacion = ObtenerRandomEntero(0,B_Padre1.length());
        for(contador = 0; contador < mutacion; contador++)
        {
        ...
        mutacion = ObtenerRandomEntero(0,C_Padre1.length());
        for(contador = 0; contador < mutacion; contador++)
        {
        ...
        mutacion = ObtenerRandomEntero(0,D_Padre1.length());
        for(contador = 0; contador < mutacion; contador++)
        {
        ...
        mutacion = ObtenerRandomEntero(0,E_Padre1.length());
        for(contador = 0; contador < mutacion; contador++)
        {
        ...
        mutacion = ObtenerRandomEntero(0,F_Padre1.length());
        for(contador = 0; contador < mutacion; contador++)
        {
